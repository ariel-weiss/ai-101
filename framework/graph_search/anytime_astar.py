    ...
    def solve_problem(self, problem: GraphProblem) -> SearchResult:
        with Timer(print_title=False) as timer:
            ...
            while (high_heuristic_weight - low_heuristic_weight) > 0.01:
                ...
                # Run weighted astar
                wastar = AStar(self.heuristic_function_type, mid_w_value,self.max_nr_states_to_expand_per_iteration)
                ...
                # Update best solution (and upper bound) or lower bound
                if wastar_res.is_solution_found:
